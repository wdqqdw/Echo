...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/kk_logic')
    ...
    train_dataset = load_dataset(args.data_path, "train")["3ppl"]
    test_dataset = load_dataset(args.data_path, "test")["3ppl"]


    def make_map_fn(split):
        def process_fn(example, idx):
            question = make_prefix(example, template_type=args.template_type)
            solution = example['solution_text_format']
            data = {
