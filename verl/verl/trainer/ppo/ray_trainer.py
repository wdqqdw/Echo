        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    # batch.non_tensor_batch["multi_modal_inputs"][0]['feature_attention_mask']
                    # batch.non_tensor_batch["multi_modal_inputs"][0]['input_features']
                    batch.non_tensor_batch["old_multi_modal_inputs"] = batch.non_tensor_batch["multi_modal_inputs"]
                    batch.non_tensor_batch["multi_modal_inputs"] = batch.non_tensor_batch["updated_multi_modal_inputs"]
