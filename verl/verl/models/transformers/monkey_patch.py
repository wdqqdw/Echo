...
def apply_monkey_patch(
    ...
    try:
        ...
        num_attention_heads, num_key_value_heads = model.config.thinker_config.text_config.num_attention_heads, model.config.thinker_config.text_config.num_key_value_heads
    ...
    if use_remove_padding or ulysses_sp_size > 1:
        if hasattr(module, "_flash_attention_forward"):
            ...
            #model.audio_tower.config.use_flash_attn=False
            #print("Close flash attention of Whisper-Qwen2-Audio at this time")
